...
# $env.POSH_THEME = (echo $"($env.USERPROFILE)\\AppData\\Local\\Programs\\oh-my-posh\\themes\\jblab_2021.omp.json")
$env.POSH_THEME = (echo $"($env.USERPROFILE)\\Documents\\dotfiles\\nt_config\\omp\\omp_config.yaml")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "c54378aa-5e7e-41e9-a06c-044fc5fefd28")
$env.POSH_SHELL = "nu"
$env.POSH_SHELL_VERSION = (version | get version)

let _omp_executable: string = (echo $"($env.USERPROFILE)/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe")
